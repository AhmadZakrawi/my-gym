...
import { useCoaches } from "../hooks/useCoaches.jsx";
...
export default function Coaches() {
  ...
  const getAllCoaches = async () => {
    ...
    coaches = coaches.map((c) => {
      return {
        ...c,
        joined: moment(new Date(c.joined)).format("MMMM Do YYYY"),
        birthday: moment(new Date(c.birthday)).format("MMMM Do YYYY"),
      };
    });
  ...
  const addCoachClicked = async () => {
    ...
    if (newCoach) {
      ...
      setAllCoaches([
        ...
        {
          ...newCoach,
          joined: moment(new Date(newCoach.joined)).format("MMMM Do YYYY"),
          birthday: moment(new Date(newCoach.birthday)).format("MMMM Do YYYY"),
        },
      ]);
    }
  };
  ...
  const columns = [
    { field: "fullName", headerName: "Full Name", disableColumnMenu: true, flex: 1, minWidth: 150  },
    { field: "gender", headerName: "Gender", disableColumnMenu: true, flex: 1 },
    { field: "role", headerName: "Role", disableColumnMenu: true, flex: 1 },
    { field: "phone", headerName: "Phone", disableColumnMenu: true, flex: 1 },
    { field: "email", headerName: "Email", disableColumnMenu: true, flex: 1, minWidth: 220 },
    { field: "joined", headerName: "Join Date", disableColumnMenu: true, flex: 1, minWidth: 140 },
    { field: "birthday", headerName: "Date of Birth", disableColumnMenu: true, flex: 1, minWidth: 140 },
    {
      field: "actions",
      headerName: "Actions",
  ...
  return (
    <>
      <>
        <TopBar name="Coaches" toggleDrawer={toggleDrawer} />
